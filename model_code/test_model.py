...
feature_extractor = load_model("D:\Cancer Detection using ML\Code\model_saved\custom_cnn_feature_extractor_final.h5")
classification_model = joblib.load("D:\Cancer Detection using ML\Code\model_saved\RF_model_final.pkl")
